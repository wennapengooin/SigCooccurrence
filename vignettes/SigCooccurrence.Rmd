...
vignette: >
  %\VignetteIndexEntry{Intro_SigCooccurrence}
...
# You can inspect the first 3 file paths
# print(vcf_files[1:3])
...
# You will see a message: "Successfully imported mutations for 9 sample(s)."
# print(muts_grl)
...
# View the first 5 signatures for the first 3 samples
# print(round(exposures[1:5, 1:3], 1))
...
# View the correlation between the first 5 signatures
# print(round(cooccur_matrix[1:5, 1:5], 2))

```

### Step 5a: Plot Co-occurrence Heatmap
...
# This plot will show which signatures (e.g., SBS1 and SBS5) co-occur
p_cosmic <- plotCooccurHeatmap(
  cooccur_matrix,
  title = "Co-occurrence of COSMIC Signatures (SNV)"
)

# To display the plot, just run:
# print(p_cosmic)
...
```{r, eval = FALSE}
# Note: NMF (Non-negative Matrix Factorization) is computationally intensive
...
# View the exposures for our 4 new signatures
# print(round(de_novo_exposures, 1))
...
# print(round(cooccur_matrix_denovo, 2))

```

### Step 5b: Plot Co-occurrence Heatmap

Finally, we plot the co-occurrence matrix for our 4 _de novo_ signatures.

```{r, eval = FALSE}
p_denovo <- plotCooccurHeatmap(
